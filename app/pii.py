...
Masks both the SSN and the salary — an employee (or an HR staffer scoped to their
own unit) should never see raw compensation or identifiers unless explicitly cleared.
"""
